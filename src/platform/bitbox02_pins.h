...
#define PIN_SPI1_CLK GPIO(GPIO_PORTA, 12)
#define PIN_SPI1_MOSI GPIO(GPIO_PORTA, 15)
#define PIN_SPI1_MISO GPIO(GPIO_PORTA, 13)
#define PIN_SPI1_CS GPIO(GPIO_PORTA, 14)
#define PIN_SPI1_HOLD GPIO(GPIO_PORTA, 20)
#define PIN_SPI1_WP GPIO(GPIO_PORTB, 7)
